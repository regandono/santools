...
===================
``>_`` Config Collector (cc) is console application for getting configurations/logs for spesific devices, all files will be securely encrypted and zip into single file.
 

Please use `Fla Console <https://github.com/regandono/santools/tree/fla>`_ to import and view.
